...
public class RegistrazioneUtente {
    ...
    public void registra(String[] pass, String[] users, String[] ems, Paziente paziente){
        String usernameAdmin = "nicog";
        String passwordAdmin = "admin";
        String clientName = "clinica";
        String role = "user";
        String[] email = ems;
        ...
        for (int i = 0; i < email.length; i++) {
            ...
            repositoryPazienti.save(paziente);
